    ...
    <section className="relative isolate flex min-h-screen items-center overflow-hidden px-6 py-16 sm:px-10 lg:px-12">
      ...
      <div className="mx-auto grid w-full max-w-7xl gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
        <div className="max-w-3xl">
          ...
          <h1 className="text-5xl font-semibold tracking-normal text-white sm:text-7xl lg:text-8xl">{t.name}</h1>
          <p className="mt-5 text-2xl font-medium text-teal-100 sm:text-3xl">{t.tagline}</p>
          <p className="mt-6 max-w-2xl text-lg leading-8 text-zinc-200 sm:text-xl">{t.description}</p>
